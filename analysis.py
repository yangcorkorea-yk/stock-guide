...
SECTORS = {
    ...
    "금융 · 은행": ["JPM", "BAC", "WFC", "GS", "MS", "C", "USB", "PNC",
                  "TFC", "BLK", "BX", "SCHW"],
    "미디어 · 엔터": ["NFLX", "DIS", "WBD", "PARA", "EA", "TTWO", "RBLX",
                    "SPOT", "LYV", "FWONK", "FOXA", "NWSA"],
    "통신": ["T", "VZ", "TMUS", "CMCSA", "CHTR", "AMX", "BCE", "TEF",
            "LUMN", "VOD", "ORAN"],
...
THEMES = {
    ...
    "전기차 · 자율주행": {
        ...
        "chain": [
            ...
            {"name": "충전·라이다", "stocks": ["CHPT", "LAZR", "OUST"]},
        ],
    },
    "우주 · 위성": {
    ...
    "로봇 · 자동화": {
        ...
        "chain": [
            {"name": "산업 로봇", "stocks": ["ABB", "ROK", "FANUY"]},
    ...
    "핀테크 · 디지털 결제": {
        ...
        "chain": [
            ...
            {"name": "디지털 지갑", "stocks": ["PYPL", "SQ", "AFRM"]},
    ...
    "데이터센터 인프라": {
        ...
        "chain": [
            ...
            {"name": "네트워킹", "stocks": ["ANET", "CSCO", "JNPR"]},
