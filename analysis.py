...
# ── 한국 vs 미국 페어 카탈로그 (1:1 비교용) ──────────
# 각 페어는 사용자가 자주 궁금해할 의미 있는 비교 조합.
# kr 종목 시세는 yfinance(KS 코드)로 시도하되 실패해도 OK — LLM이
# 카탈로그의 desc·reason으로 비교.
KR_US_PAIRS = [
    {"theme": "🧠 파운드리",
     "kr": {"name": "삼성전자", "ticker": "005930.KS",
            "desc": "메모리 1위 + 파운드리 2위. 종합 반도체 IDM."},
     "us": {"name": "TSMC", "ticker": "TSM",
            "desc": "글로벌 파운드리 1위. NVDA·AAPL 핵심 고객."},
     "reason": "파운드리 1·2위 경쟁. 첨단 공정·고객 점유율 차이."},
    {"theme": "💾 메모리 반도체",
     "kr": {"name": "SK하이닉스", "ticker": "000660.KS",
            "desc": "DRAM·NAND 메이저. HBM 시장 1위."},
     "us": {"name": "마이크론", "ticker": "MU",
            "desc": "DRAM·NAND 3위. HBM 후발이지만 성장."},
     "reason": "DRAM·HBM 글로벌 양강 비교."},
    {"theme": "💾 메모리 반도체",
     "kr": {"name": "삼성전자", "ticker": "005930.KS",
            "desc": "메모리 1위. HBM에서 SK하이닉스에 밀리는 중."},
     "us": {"name": "마이크론", "ticker": "MU",
            "desc": "메모리 3위. HBM 성장 모멘텀."},
     "reason": "메모리 1위 vs 3위. HBM 전환 속도."},
    {"theme": "🔍 검색·인터넷",
     "kr": {"name": "네이버", "ticker": "035420.KS",
            "desc": "한국 검색 1위. AI·웹툰·커머스 확장."},
     "us": {"name": "알파벳", "ticker": "GOOGL",
            "desc": "글로벌 검색 1위. 광고+클라우드+AI."},
     "reason": "한국 검색 vs 글로벌 검색."},
    {"theme": "💬 소셜·메신저",
     "kr": {"name": "카카오", "ticker": "035720.KS",
            "desc": "국민 메신저. 금융·콘텐츠·모빌리티 확장."},
     "us": {"name": "메타", "ticker": "META",
            "desc": "글로벌 SNS. AI·VR 대규모 투자."},
     "reason": "국민 플랫폼 vs 글로벌 SNS 광고 모델."},
    {"theme": "🚗 전기차",
     "kr": {"name": "현대차", "ticker": "005380.KS",
            "desc": "EV 전환 가속. 아이오닉 시리즈."},
     "us": {"name": "테슬라", "ticker": "TSLA",
            "desc": "글로벌 EV 1위. 자율주행·로봇 베팅."},
     "reason": "전통 OEM의 EV 전환 vs EV 네이티브."},
    {"theme": "🔋 배터리",
     "kr": {"name": "LG에너지솔루션", "ticker": "373220.KS",
            "desc": "글로벌 배터리 2~3위. NCM 강자."},
     "us": {"name": "테슬라", "ticker": "TSLA",
            "desc": "EV 1위, 자체 배터리(4680) 확대."},
     "reason": "배터리 공급자 vs 수요자(겸 자체 생산)."},
    {"theme": "🛒 이커머스",
     "kr": {"name": "쿠팡", "ticker": "CPNG",
            "desc": "한국 이커머스 1위 (미국 NYSE 상장)."},
     "us": {"name": "아마존", "ticker": "AMZN",
            "desc": "글로벌 이커머스·AWS 1위."},
     "reason": "한국 1위(미국 상장) vs 글로벌 1위 직접 비교."},
    {"theme": "💉 제약·바이오",
     "kr": {"name": "셀트리온", "ticker": "068270.KS",
            "desc": "바이오시밀러 글로벌 3위급."},
     "us": {"name": "일라이릴리", "ticker": "LLY",
            "desc": "GLP-1(젭바운드) 비만 치료제 글로벌 1위."},
     "reason": "바이오시밀러 vs 혁신 신약 메가캡."},
    {"theme": "🧬 바이오 CDMO",
     "kr": {"name": "삼성바이오로직스", "ticker": "207940.KS",
            "desc": "글로벌 CDMO 생산 1위(용량 기준)."},
     "us": {"name": "일라이릴리", "ticker": "LLY",
            "desc": "혁신 신약 + 자체 생산 + 외주(CDMO 고객)."},
     "reason": "위탁 생산자 vs 혁신 의약품 고객사 관점."},
    {"theme": "🎮 게임",
     "kr": {"name": "엔씨소프트", "ticker": "036570.KS",
            "desc": "리니지 IP. MMORPG 강자."},
     "us": {"name": "일렉트로닉아츠", "ticker": "EA",
            "desc": "FIFA·매든·심즈 IP. 글로벌 메이저."},
     "reason": "한국 MMORPG vs 글로벌 스포츠·캐주얼 게임."},
    {"theme": "🎵 엔터",
     "kr": {"name": "하이브", "ticker": "352820.KS",
            "desc": "BTS·뉴진스 등 K-팝 1위."},
     "us": {"name": "워너뮤직", "ticker": "WMG",
            "desc": "글로벌 메이저 음반사 3위."},
     "reason": "K-팝 신성장 vs 전통 음반 IP."},
    {"theme": "☀️ 신재생",
     "kr": {"name": "한화솔루션", "ticker": "009830.KS",
            "desc": "큐셀 태양광 모듈, 북미 시장 강자."},
     "us": {"name": "퍼스트솔라", "ticker": "FSLR",
            "desc": "박막 태양광 모듈 미국 1위. IRA 수혜."},
     "reason": "태양광 모듈 한·미 강자 비교."},
    {"theme": "⚡ 원자력·전력",
     "kr": {"name": "두산에너빌리티", "ticker": "034020.KS",
            "desc": "원전 주기기·SMR EPC 강자."},
     "us": {"name": "GE 버노바", "ticker": "GEV",
            "desc": "전력 장비·터빈 글로벌 1위. SMR 협력."},
     "reason": "원전 EPC 한·미 비교, AI 전력 수혜 공통."},
]
